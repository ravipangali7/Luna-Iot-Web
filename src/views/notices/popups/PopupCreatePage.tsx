...
const PopupCreatePage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setError(result.error || 'Failed to create popup');
      }
    } catch (error) {
      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Create Popup</h1>
              <p className="text-gray-600">Add a new popup to the system</p>
            </div>
          </div>
        </div>
