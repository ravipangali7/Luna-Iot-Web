...
const SwitchViewPage: React.FC = () => {
  ...
  const [switchItem, setSwitchItem] = useState<CommunitySirenSwitch | null>(null);
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const switchResponse = await communitySirenSwitchService.getById(Number(id));
      setSwitchItem({
        ...switchResponse,
  ...
  const handleDelete = async () => {
    ...
    if (confirmed) {
      try {
        await communitySirenSwitchService.delete(switchItem.id);
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Community Siren Switch Details</p>
            </div>
          </div>
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{switchItem.device_phone} - {switchItem.device_imei}</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">{switchItem.trigger} meters</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">{switchItem.secondary_phone || 'N/A'}</p>
                </div>
