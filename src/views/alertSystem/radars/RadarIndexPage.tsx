...
const RadarIndexPage: React.FC = () => {
  ...
  // Removed per-item View; keep token-based monitor

  // Handle view radar monitor
  const handleViewMonitor = (token: string) => {
    const radarUrl = `${window.location.origin}/alert-system/radar/token/${token}`;
                      ...
                      <TableCell>
                        <div className="flex space-x-2">
                          ...
                          <Button
                            variant="success"
                            size="sm"
                            onClick={() => handleViewMonitor(radar.token)}
                            icon={
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                              </svg>
